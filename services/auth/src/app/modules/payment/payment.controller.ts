...
const successPayment = asyncHandler(async (req: Request, res: Response) => {
...
const getInvoiceDownloadUrl = asyncHandler(
...
const validatePayment = asyncHandler(async (req: Request, res: Response) => {
