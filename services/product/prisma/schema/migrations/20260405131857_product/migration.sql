-- CreateEnum
CREATE TYPE "PaymentGateway" AS ENUM ('STRIPE', 'SSLCOMMERZ', 'BKASH', 'NAGAD', 'ROCKET', 'UPAY');
...
-- CreateIndex
CREATE UNIQUE INDEX "auth_providers_email_provider_key" ON "auth_providers"("email", "provider");
...
-- AddForeignKey
ALTER TABLE "auth_providers" ADD CONSTRAINT "auth_providers_email_fkey" FOREIGN KEY ("email") REFERENCES "users"("email") ON DELETE CASCADE ON UPDATE CASCADE;
